import { stack } from "../../content/studyHubContent";
import SectionHeading from "../../components/SectionHeading";

export default function StudyHubStack() {
  return (
    <section id="studyhub-stack" className="border-b border-ledger-line py-16 sm:py-20">
